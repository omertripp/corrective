...
\begin{itemize}
	...
	\item \underline{Concurrency level:} For a fixed workload size, set at 10 (\pengtodo{please confirm}), the number of threads is varied along the range of 1 to 32 threads.  
\end{itemize}
...
\begin{figure*}
	\begin{minipage}{0.375 \textwidth}
		\includegraphics[trim=10 0 10 10, width=\textwidth]{../../eval/32threads/case1it.pdf}
		\caption{\label{Fi:case1it}Apache Tomcat {\sf ApplicationContext}: workload}
	\end{minipage}
	\hspace{0.25 \textwidth}
	\begin{minipage}{0.375 \textwidth}
		\includegraphics[trim=10 10 10 10, width=\textwidth]{../../eval/32threads/case1th.pdf}
				\caption{\label{Fi:case1th}Apache Tomcat {\sf ApplicationContext}: concurrency}
	\end{minipage}
	\begin{minipage}{0.375 \textwidth}
		\includegraphics[trim=10 10 10 10, width=\textwidth]{../../eval/32threads/case2it.pdf}
						\caption{\label{Fi:case2it}dyuproject {\sf StandardConvertorCache}: workload}
	\end{minipage}
	\hspace{0.25 \textwidth}
	\begin{minipage}{0.375 \textwidth}
		\includegraphics[trim=10 10 10 10, width=\textwidth]{../../eval/32threads/case2th.pdf}
						\caption{\label{Fi:case2th}dyuproject {\sf StandardConvertorCache}: concurrency}
	\end{minipage}
	\begin{minipage}{0.375 \textwidth}
		\includegraphics[trim=10 10 10 10, width=\textwidth]{../../eval/32threads/case3it.pdf}
			\caption{\label{Fi:case3it}Flexive {\sf FxValueRendererFactory}: workload}
	\end{minipage}
		\hspace{0.25 \textwidth}
	\begin{minipage}{0.375 \textwidth}
		\includegraphics[trim=10 10 10 10, width=\textwidth]{../../eval/32threads/case3th.pdf}
			\caption{\label{Fi:case3th}Flexive {\sf FxValueRendererFactory}: concurrency}
	\end{minipage}
	\begin{minipage}{0.375 \textwidth}
		\includegraphics[trim=10 10 10 10, width=\textwidth]{../../eval/32threads/case4it.pdf}
		\caption{\label{Fi:case4it}Gridkit {\sf ReflectionPofSerializer}: workload}
	\end{minipage}
	\hspace{0.25 \textwidth}
	\begin{minipage}{0.375 \textwidth}
		\includegraphics[trim=10 10 10 10, width=\textwidth]{../../eval/32threads/case4th.pdf}
