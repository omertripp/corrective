...
\begin{figure*}
	\begin{minipage}{0.50 \textwidth}
		...
		\caption{\label{Fi:case1th}Apache Tomcat {\sf ApplicationContext}\vspace{10pt}}
	\end{minipage}
	\begin{minipage}{0.5 \textwidth}
		...
		\caption{\label{Fi:case2th}dyuproject {\sf StandardConvertorCache}\vspace{10pt}}
	\end{minipage}
	\begin{minipage}{0.5 \textwidth}
...
We depict the performance results in Figures \ref{Fi:case1th}-\ref{Fi:case4th}. 
