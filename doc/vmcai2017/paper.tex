...
\author{
  Pietro Ferrara \inst{1}
  \and Omer Trip \inst{2}
  \and Peng Liu \inst{3}
...
Google\footnote{The research leading to this paper was conducted while the author was at IBM Research.} \and IBM Research \and Yale University
}
\maketitle
